...
%$M$ permet d'estimer la complexité pour l'attaquant s'il veut attaquer tous les ordinateurs du système.
%Plus ce nombre est élevé, plus la difficulté est importante.
%
%\paragraph{L'impact des mises à jours}
%Dans le paragraphe précédent, nous avons expliqué l'intérêt de la diversité des versions.
%Toutefois, nous n'avons pas pris en compte l'ancienneté d'une vulnérabilité. 
%L'ancienneté d'une vulnérabilité la rend plus facilement exploitable car elle a une plus grande probabilité d'être connue.
%De plus, comme expliqué dans la section~\ref{sec:modelMath}, le fait de faire des mises à jour forcera l'attaquant à augmenter l'effort pour être capable de s'adapter à ce changement.
%
...
%Finalement, nous sommes capable d'estimer l'effort nécessaire pour un attaquant pour déterminer les différentes versions de logiciels utilisées lors d'une mise à jour.
